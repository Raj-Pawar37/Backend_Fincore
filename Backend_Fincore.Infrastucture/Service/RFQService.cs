...
namespace Backend_Fincore.Application.Services
{
    public class RFQService : IRFQService
    {
        ...
        public RFQService(AppDbContext context, IMapper mapper, ICurrentUserService current)
        {
            _context = context;
            _mapper = mapper;
            _current = current;
        ...
        {
            return await _context.RFQ.Where(r => r.IsActive == 1).CountAsync();
        }
        ...
        public async Task<List<RFQResponseDto>> GetAllAsync(PaginationDTO pagination)
        {
            ...
            return _mapper.Map<List<RFQResponseDto>>(rfqs);
        }
        ...
        public async Task<RFQResponseDto> GetByIdAsync(int id)
        {
            ...
            return _mapper.Map<RFQResponseDto>(rfq);
        }
